...
describe('BookElectronicModule', () => {
    ...
    it('Correctly handle owner modifications', () => {
        ...
        expect(bookElectronicModule.book.owner).toBe('/users/1');

        bookElectronicModule.setOwner('/users/2');
        expect(bookElectronicModule.book.owner).toBe('/users/2');
    ...
    it('Correctly handle new book file', async () => {
        ...
        requestService.sendFile = jest.fn().mockImplementationOnce(() => {
    ...
    it('Correctly save book', async () => {
        ...
        expect(fetchCall[0].getUrlBuilder().getUrl()).toMatch(/\/electronic_books$/);
